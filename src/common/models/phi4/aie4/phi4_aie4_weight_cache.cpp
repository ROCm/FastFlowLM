/// \file phi4_aie4_weight_cache.cpp
...
constexpr const char* kIndexName = "phi4-aie4-weights.json";
constexpr const char* kDataName = "phi4-aie4-weights.bin";
...
std::optional<std::filesystem::path> WeightCacheDirectory(
    ...
    const char* configured = std::getenv("FLM_AIE4_WEIGHT_CACHE");
