/// \file hunyuan_npu.hpp
/// \brief hunyuan_npu class
/// \author FastFlowLM Team
/// \date 2026-09-01
/// \note This is a header file for the hunyuan_npu class, the engine for the
///       `hunyuan-dense` architecture (Hy-MT2-1.8B). Q4_0 body, per head q/k
///       RMS norms applied *after* rope.
#pragma once
...
class hunyuan_npu : public causal_lm{
public:
    /// \brief  initialize the hunyuan_npu
    /// \param config the configuration
    /// \param npu_instance the npu instance
    hunyuan_npu(LM_Config config, npu_xclbin_manager *npu_instance, int MAX_L = 4096);
    ~hunyuan_npu();

    /// \brief forward the hunyuan_npu
    /// \param ids the ids
