...
> - Hy-MT2 is a dedicated translation model tuned for short, single-turn requests, so it is benchmarked up to 8k max context length rather than the longer sweeps used for general chat models.
...
|------------------|--------------------|--------:|--------:|--------:|--------:|
| **Hy-MT2-1.8B**  | NPU (FLM)    | 52.2 | 46.2 | 38.9 | 28.4 |
...
| **Model**        | **HW**       | **1k** | **2k** | **4k** | **8k** |
|------------------|--------------------|--------:|--------:|--------:|--------:|
| **Hy-MT2-1.8B**  | NPU (FLM)    | 1,068 | 1,051 | 1,013 | 912 |
